...
namespace StringSearch
{
    ...
    public partial class SearchForm : Form
    {
          ...
          EventArgs e)
        {
            ...
            {
                chkRvtLinks.Checked = _last_search_options.LinkedFiles;
          ...
          FormClosingEventArgs e)
        {
            if (_ok_clicked)
            {
                if (0 == cmbSearchString.Text.Length)
                {
                    e.Cancel = true;
                    _ok_clicked = false;
                    Autodesk.Revit.UI.TaskDialog.Show("Alert",
            "Please specify a search string.");
                }
                else if (chkRvtLinks.Checked && rbView.Checked)
                {
                    e.Cancel = true;
                    _ok_clicked = false;
    ...
    static int[] _minimum_height = new[] { 235, 348, 418, 485, 505 };
      ...
      label3.Visible = _minimum_height[4] < h;
        ...
        public bool RvtLinks
        {
            get { return chkRvtLinks.Checked; }
        }
